...
<style>
    ...
    .modern-table td {
        padding: 12px 8px; font-size: 15px; color: #1f2937; text-align: right; border-bottom: 1px solid #f3f4f6;
    }
    ...
    td {
        font-size: 10px !important;
        padding: 2px 1px !important; /* 여백 거의 없음 */
...
for i, tab in enumerate(tabs):
    ...
    with tab:
        ...
        styler = styler.set_properties(subset=pre_cols, **{'background-color': '#f8f9fa', 'color': '#9ca3af', 'font-size': '10px'})
        ...
        styler = styler.set_properties(subset=curr_cols, **{'font-weight': '700', 'font-size': '10px', 'border-left': '1px solid #cbd5e1', 'border-right': '1px solid #cbd5e1'})
        ...
        styler = styler.set_properties(subset=var_cols, **{'background-color': '#fffbeb', 'font-size': '10px'})
