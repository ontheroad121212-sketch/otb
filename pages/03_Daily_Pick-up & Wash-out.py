...
# ==============================================================================
# 4. 파일 처리 로직 (핀셋 수정: 합계 줄 제거 로직 강화)
# ==============================================================================
...
def process_res_file(file):
    ...
    try:
        ...
        # 4. [핵심] 객실수가 50개 이상인 단일 예약은 찌꺼기로 간주하고 삭제 (합계행 방지)
        df = df[df['Rooms'] < 50] 

        # 5. [핵심] 예약번호 길이가 너무 짧은 것 삭제 (빈칸 등)
