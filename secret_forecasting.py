...
def run_forecasting():
    ...
    # 요일 지수가 없으면 기본값 1.0 사용 (4만 건 분석 데이터 활용)
    ...
    with res_c2:
        ...
        st.caption(f"※ 요일 지수({auto_dow_index:.2f}x)와 가속도({accel:.1f}x)가 적용되었습니다.")
